...
class Settings(BaseSettings):
    ...
    CLICKHOUSE_EVAL_CONCURRENCY: int = 1
    CLICKHOUSE_QUERY_MAX_THREADS: int = 1
    CLICKHOUSE_BLOCK_SIZE: int = 10_000
    CLICKHOUSE_MAX_HOLDING_SECONDS: int = 3_600
    CLICKHOUSE_ENTRY_COOLDOWN_SECONDS: int = 60
    CLICKHOUSE_BACKTEST_CHUNK_DAYS: int = 7
    CLICKHOUSE_FEATURE_WARMUP_SECONDS: int = 3_600
