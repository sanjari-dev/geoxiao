...
# DNA ID: 7b5c55b6-5d6a-4abc-bfc8-00a118393fd6
# Generation: 0
# Tree: cube(sigmoid(div(sign(min2(kurtosis, obi)), sigmoid(neg(spread_dyn)))))
...
class Strategy_5ca3dfbe_10f8_4d(BaseStrategy):
    ...
    def generate_signal(self, features: dict) -> dict | None:
        ...
        signal = cube(sigmoid(div(sign(min2(kurtosis, obi)), sigmoid(neg(spread_dyn)))))
